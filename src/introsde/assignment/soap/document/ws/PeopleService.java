 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://ws.document.soap.assignment.introsde/", wsdlLocation = "http://localhost:6907/ws/people?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PEOPLESERVICE_QNAME = new QName("http://ws.document.soap.assignment.introsde/", "PeopleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:6907/ws/people?wsdl");
    ...
    public People getPeopleImplPort() {
        return super.getPort(new QName("http://ws.document.soap.assignment.introsde/", "PeopleImplPort"), People.class);
    }
    ...
    public People getPeopleImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.document.soap.assignment.introsde/", "PeopleImplPort"), People.class, features);
    }
